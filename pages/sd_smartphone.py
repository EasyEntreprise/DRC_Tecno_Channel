...
def layout():
    return dmc.Container(
        ...
        dmc.Title("SD SMART PHONE", order= 1, style={"marginTop": 20}), # order = 1, correspond a H1
        html.Hr(),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children= [
                                            ...
                                            dmc.Text(id = "metric-SD-KIN", size="xl", fw=700),
                                        ], withBorder= True, p= "md", shadow= "xs",
                                    )
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children= [
                                            ...
                                            dmc.Text(id = "metric-SD-KAT", size="xl", fw=700),
                                        ], withBorder= True, p= "md", shadow= "xs",
                                    )
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children= [
                                            ...
                                            dmc.Text(id = "metric-SD-KC", size="xl", fw=700),
                                        ], withBorder= True, p= "md", shadow= "xs",
                                    )
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children= [
                                            ...
                                            dmc.Text(id = "metric-SD-BK", size="xl", fw=700),
                                        ], withBorder= True, p= "md", shadow= "xs",
                                    )
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children= [
                                            ...
                                            dmc.Text(id = "metric-SD-BE", size="xl", fw=700),
                                        ], withBorder= True, p= "md", shadow= "xs",
                                    )
                                ),
                            ]
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children = [
                                                    ...
                                                    dmc.Text(id = "metric-SD-ALL", size="xl", fw=700)
                                                ], 
                                                withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children = [
                                                    ...
                                                    dmc.Text(id = "metric-ALL-Achat", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children= [
                                                    ...
                                                    dmc.Text(id = "metric-ALL-Invest", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                    ]
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children= [
                                                    ...
                                                    dmc.Text(id= "metric-achat-Kin", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children =[
                                                    ...
                                                    dmc.Text(id= "metric-achat-Kat", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs")
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children=[
                                                    ...
                                                    dmc.Text(id= "metric-achat-KC", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children= [
                                                    ...
                                                    dmc.Text(id= "metric-achat-BK", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                        ...
                                        dmc.GridCol(
                                            ...
                                            children = dmc.Paper(
                                                ...
                                                children= [
                                                    ...
                                                    dmc.Text(id= "metric-achat-BE", size="xl", fw=700)
                                                ], withBorder= True, p= "md", shadow= "xs"
                                            )
                                        ),
                                    ]
                            ...
                            dmc.GridCol(
                                ...
                                children = dmc.Grid(
                                    ...
                                    children = [
                                        ...
                                        dmc.GridCol(
                                            span = 6,
                                            children = dmc.Paper(dcc.Graph(id="Graphic-Pie-City"), withBorder= True, p= "md", style={**style_boite, "height": "300px"})
                                        ),
        ...
        dash_table.DataTable(
            id = 'tableau-datasets-qty-sp',

            # Les colonnes sont définies une seule fois au chargement initial
            columns = [
                {"name": c, "id": c} for c in sd_data_sp.columns # tableau
            ], page_size = 10,
        ...
        dmc.Grid(
            ...
            children= [
                dmc.GridCol(
                    span= 12,
                    children= dmc.Paper(dcc.Graph(id="Graphic-line-month"), withBorder= True, p= "md", style={**style_boite, "height": "300px"})
                )
            ]
        ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children=[
                                            ...
                                            dmc.Text(id= "metric-average-sp", size="xl", fw=700),
                                        ], 
                                        withBorder= True, p= "md", shadow= "xs",
                                    ),
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children=[
                                            ...
                                            dmc.Text(id= "metric-median-sp", size="xl", fw=700),
                                        ], 
                                        withBorder= True, p= "md", shadow= "xs",
                                    ),
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children=[
                                            ...
                                            dmc.Text(id= "metric-ecarType-sp", size="xl", fw=700),
                                        ], 
                                        withBorder= True, p= "md", shadow= "xs",
                                    ),
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children=[
                                            ...
                                            dmc.Text(id= "metric-max-sp", size="xl", fw=700),
                                        ], 
                                        withBorder= True, p= "md", shadow= "xs",
                                    ),
                                ),
                                ...
                                dmc.GridCol(
                                    ...
                                    children= dmc.Paper(
                                        children=[
                                            ...
                                            dmc.Text(id= "metric-min-sp", size="xl", fw=700),
                                        ], 
                                        withBorder= True, p= "md", shadow= "xs",
                                    ),
                                ), 
                        ...
                        children = [
                            dmc.GridCol(
                                ...
                                children = dmc.Paper(
                                    ...
                                    children= [
                                        dcc.Graph(id= "moustache-graph_spd"),
                                        dcc.Graph(id='graphic-histo_spd'),
                                    ], withBorder= True, p= "md", style={**style_boite, "height": "300px"})
                            ),
                            ...
                            dmc.GridCol(
                                span = 12,
                                children = dmc.Paper(dcc.Graph(id= "graphic-scatter_spd"), withBorder= True, p= "md", style={**style_boite, "height": "300px"})
                            ),
                        ]
                    )
                ) 
            ...
            children = [
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dcc.Graph(id= "graphic-pie-all-sd")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dcc.Graph(id = "sd-bar-by-marketCity_sp")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dcc.Graph(id = "sd-pie-by-marketCity_sp")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dcc.Graph(id = "sd-bar-by-marketCityChoose_sp")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            #"Graphique en Pie qui afficher les clients du city choisi"
                            dcc.Graph(id = "sd-pie-by-marketCityChoose_sp")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
        ...
        dmc.Grid(
            ...
            children = [
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            #"Graphique en Bar qui affiche les series"
                            dcc.Graph(id="fig_bar_series")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            #"Graphique en Pie qui affiche les series"
                            dcc.Graph(id="fig_pie_series")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dcc.Graph(id="fig_line_modelMulti")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dmc.Text(id = "metric-SD-Name", size="xl", fw=700),
                        ],
                        withBorder= True, p="md", shadow= "xs"
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dmc.Text(id = "metric-SD-achat", size="xl", fw=700),
                        ],
                        withBorder= True, p="md", shadow= "xs"
                    )
                ),
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            ...
                            dmc.Text(id = "metric-SD-invest", size="xl", fw=700),
                        ],
                        withBorder= True, p="md", shadow= "xs"
                    )
                ),
        ...
        dmc.Grid(
            ...
            children = [
                ...
                dmc.GridCol(
                    ...
                    children = dmc.Paper(
                        children = [
                            #"Graphique en Bar qui affiche tout les series acheter par le client"
                            dcc.Graph(id= "sd-bar-series"),
                            dcc.Graph(id= "sd-pie-series")
                        ],
                        withBorder= True, p="md", style={**style_boite, "height": "300px"}
                    )
                ),
...
# ==========================================
@dash.callback(
        [Output('nuage-points-sd-sp', 'data'),
         Output('nuage-points-sd-sp', 'value'),
        ],
        [Input('date-picker-sd-sp', 'start_date'),
         Input('date-picker-sd-sp', 'end_date'),
        ]
)

def maj_liste_deroulanteOne_sp(debut, fin):
    if not debut or not fin :
        produits_uniques_sp = sd_data_sp["Products"].unique()
        ...
        df_temp          = sd_data_sp[(sd_data_sp["Date"] >= start_date) & (sd_data_sp["Date"] <= end_date)]
...
# ==========================================
@dash.callback(
        [Output('dropdown-city_sd_sp', 'data'),
         Output('dropdown-city_sd_sp', 'value'),
        ],
        [Input('date-picker-sd-sp', 'start_date'),
         Input('date-picker-sd-sp', 'end_date'),
        ]
...
def maj_liste_deroulanteTwo_sp(debut, fin):
    if not debut or not fin :
        city_uniques = sd_data_sp["Cities"].unique()
...
# ==========================================
@dash.callback(
        [Output('multiselect-models_spD', 'data'),
         Output('multiselect-models_spD', 'value'),
        ],
        [Input('date-picker-sd-sp', 'start_date'),
         Input('date-picker-sd-sp', 'end_date'),
        ]
...
def maj_liste_deroulanteThree_sp(debut, fin):
    if not debut or not fin :
        models_uniques = sd_data_sp["Products"].unique()
...
# ==========================================
@dash.callback(
        [Output('sub-dealer-profil-sd-sp', 'data'),
         Output('sub-dealer-profil-sd-sp', 'value'),
        ],
        [Input('date-picker-sd-sp', 'start_date'),
         Input('date-picker-sd-sp', 'end_date'),
        ]
...
def maj_liste_deroulanteFour_sp(debut, fin):
    if not debut or not fin :
        subDealers_uniques_sp = sd_data_sp["Customers_Name"].unique()
...
@dash.callback(
    [
        # Metric
        Output('metric-SD-KIN', 'children'),
        Output('metric-SD-KAT', 'children'),
        Output('metric-SD-KC', 'children'),
        Output('metric-SD-BK', 'children'),
        Output('metric-SD-BE', 'children'),
        Output('metric-SD-ALL', 'children'),
        Output('metric-ALL-Achat', 'children'),
        Output('metric-ALL-Invest', 'children'),
        Output('metric-achat-Kin', 'children'),
        Output('metric-achat-Kat', 'children'),
        Output('metric-achat-KC', 'children'),
        Output('metric-achat-BK', 'children'),
        Output('metric-achat-BE', 'children'),
        Output('metric-average-sp', 'children'),
        Output('metric-median-sp', 'children'),
        Output('metric-ecarType-sp', 'children'),
        Output('metric-max-sp', 'children'),
        Output('metric-min-sp', 'children'),
        Output('metric-SD-Name', 'children'),
        Output('metric-SD-achat', 'children'),
        Output('metric-SD-invest', 'children'),

        # Graphic
        Output('Graphic-Bar-City', 'figure'),
        Output('Graphic-Pie-City', 'figure'),
        Output('Graphic-line-month', 'figure'),
        Output('moustache-graph_spd', 'figure'),
        Output('graphic-histo_spd', 'figure'),
        Output('graphic-scatter_spd', 'figure'), 
        Output('sd-bar-by-city', 'figure'),
        Output('sd-pie-by-city', 'figure'),
        Output('graphic-pie-all-sd', 'figure'),
        Output('fig_bar_models', 'figure'),
        Output('fig_bar_series', 'figure'),
        Output('fig_pie_series', 'figure'),
        Output('fig_line_modelMulti', 'figure'),  # Apres ici
        Output('sd-radar', 'figure'),
        Output('sd-line-annee', 'figure'),
        Output('sd-line-achat', 'figure'),
        Output('sd-bar-models', 'figure'),
        Output('sd-bar-series', 'figure'),
        Output('sd-pie-series', 'figure'),
        Output('sd-bar-by-marketCity_sp', 'figure'),
        Output('sd-pie-by-marketCity_sp', 'figure'),
        Output('sd-bar-by-marketCityChoose_sp', 'figure'),
        Output('sd-pie-by-marketCityChoose_sp', 'figure'),

        # Tableau
        Output('tableau-client-qty-sp', 'data'),
        Output('model-table-sd-sp', 'data'),
        Output('tableau-datasets-qty-sp', 'data'),
    ],
    [
        Input('date-picker-sd-sp', 'start_date'),  # Input 1 : Date de début
        Input('date-picker-sd-sp', 'end_date'),
        Input('nuage-points-sd-sp', 'value'),
        Input('dropdown-city_sd_sp', 'value'),
        Input('multiselect-models_spD', 'value'),
        Input('sub-dealer-profil-sd-sp', 'value'),
    ]
)
...
def filter_data(debut, fin, produit, city, models, clients):
    ...
    if not debut or not fin:
        df_filtre = sd_data_sp.copy()
    else:
        # 2. Filtrage strict du DataFrame Pandas avec vos variables 'debut' et 'fin'
        start_date = pd.to_datetime(debut)
        end_date = pd.to_datetime(fin)
        df_filtre = sd_data_sp[(sd_data_sp['Date'] >= start_date) & (sd_data_sp['Date'] <= end_date)]
    ...
    fig_bar_city = px.bar(bar_city, x="Cities", y="Purchases_Qty", color="Cities", text="Purchases_Qty", title="City situation for SD-SP")
    ...
    monthly_sd= px.line(monthly_all , x="Date", y="Purchases_Qty", text= "Purchases_Qty", title="Monthly purchase FOR SD-SP")
    ...
    # 12. Graphique en Pie pour all series
    fig_pie_series = go.Figure(data = [go.Pie(labels = bar_series["SERIES"], values= bar_series["Purchases_Qty"], title = "Series Proportions for SD-SP", opacity=0.5)])
    ...
    fig_pie_series.update_layout(margin = dict(l=10, r=10, t=30, b=10), paper_bgcolor = '#F8F9FA', title_font= dict(size= 16), font= dict(size= 8), width = 380, height = 290)
    ...
    # 14. Graphique en Line pour afficher les achats
    ...
    # 15. Graphique en Line pour afficher les achats annuel
    ...
    return kinshasa, katanga, kcongo, bkasai, bequator, total_sd, total_somme, total_revenu, kin, kat, kc, bk, be, static_mean_spSD, static_median_spSD, static_ecartT, maximum, minimum, sd_name, sd_purchase, sd_revenu, fig_bar_city, fig_pie_city, monthly_sd, fig_boite_moust, fig_hist_spD, fig_scatter, fig_bar_citySelect, fig_pie_citySelect, fig_pie_allSD, fig_bar_models, fig_bar_series, fig_pie_series, fig_line_modelMulti, fig_profil, sd_years_line, client_line_model, client_bar_models, client_bar_series, client_pie_series, fig_bar_market, fig_pie_market, fig_bar_marketSelect, fig_pie_marketSelect, donnees_tableau, donnees_tableau2, donnees_tableau3
